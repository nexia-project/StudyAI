...
export const PREMIUM_QUALITY_LOOP_MODULES: PremiumQualityLoopModule[] = [
  ...
  },
  {
    ...
    cadence: "daily",
    ownerAgent: "qa_sintetico",
    surfaces: ["artifacts/studyai/src/pages/Notebook.tsx", "artifacts/studyai/src/pages/Professor.tsx#Notebook do Professor", "/api/notebook", "/api/notebook/teacher-output", "/api/rag-multi"],
    evidenceSources: ["notebook_material_generated", "teacher_notebook_output_generated", "notebook_feedback", "hermes_notebook_rag", "content gaps"],
    dailyChecklist: [
      "Material premium tem objetivo, fonte/evidência, exemplos e checkpoint",
      "Notebook do Professor gera plano/roteiro/atividade/rubrica com contexto docente, não tela genérica de aluno",
    ...
    metrics: ["notebook_material_generated", "teacher_notebook_output_generated", "notebook_feedback negativo", "visual slots resolvidos", "contentIndex.contentGaps"],
    acceptanceCriteria: [
      ...
      "Saídas docentes incluem condução do professor, avaliação, adaptação, evidências e revisão humana",
