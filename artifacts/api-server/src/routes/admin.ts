...
router.get("/admin/stats", async (req: Request, res: Response) => {
  ...
  const [
    ...
    safeQueryOne("tiagaoRange",  () => db.execute(sql`SELECT COUNT(*)::int AS count FROM tiagao_conversations WHERE created_at::date BETWEEN ${rangeFrom}::date AND ${rangeTo}::date`)),
