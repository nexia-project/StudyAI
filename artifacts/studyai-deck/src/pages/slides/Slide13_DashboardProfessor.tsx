        ...
        <div className="grid grid-cols-3 gap-[1.5vw] flex-1">
          <div className="flex flex-col gap-[1.5vw]">
            <div className="rounded-[1vw] p-[1.8vw]" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}>
              <p className="font-display font-bold mb-[1.5vh]" style={{ fontSize: "1.3vw", color: "#94A3B8" }}>Visao Geral — Turma A</p>
              <div className="flex flex-col gap-[1.2vh]">
                ...
                <div className="flex justify-between items-center">
                  <span className="font-body" style={{ fontSize: "1.1vw", color: "#CBD5E1" }}>Media de aproveitamento</span>
            ...
            <div className="rounded-[1vw] p-[1.8vw] flex-1" style={{ background: "rgba(239,68,68,0.08)", border: "1px solid rgba(239,68,68,0.2)" }}>
              <p className="font-display font-bold mb-[1.5vh]" style={{ fontSize: "1.3vw", color: "#EF4444" }}>Alertas — Atencao Necessaria</p>
              <div className="flex flex-col gap-[1.2vh]">
                <div className="rounded-[0.5vw] p-[1vw]" style={{ background: "rgba(239,68,68,0.1)" }}>
                  ...
                  <p className="font-body" style={{ fontSize: "0.9vw", color: "#94A3B8" }}>Ultima sessao: Quarta-feira</p>
                </div>
                <div className="rounded-[0.5vw] p-[1vw]" style={{ background: "rgba(239,68,68,0.1)" }}>
                  <p className="font-body font-medium" style={{ fontSize: "1.1vw", color: "#F1F5F9" }}>Pedro Lima — abaixo de 40%</p>
                  <p className="font-body" style={{ fontSize: "0.9vw", color: "#94A3B8" }}>Matematica: 38% de acerto</p>
                </div>
                <div className="rounded-[0.5vw] p-[1vw]" style={{ background: "rgba(239,68,68,0.1)" }}>
                  <p className="font-body font-medium" style={{ fontSize: "1.1vw", color: "#F1F5F9" }}>Lucas Souza — sem revisoes</p>
          ...
          <div className="col-span-2 flex flex-col gap-[1.5vw]">
            ...
            <div className="grid grid-cols-2 gap-[1.5vw] flex-1">
              <div className="rounded-[1vw] p-[1.8vw]" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}>
                <p className="font-display font-bold mb-[1.5vh]" style={{ fontSize: "1.3vw", color: "#94A3B8" }}>Relatorio Automatico</p>
                <p className="font-body mb-[1.5vh]" style={{ fontSize: "1.2vw", color: "#CBD5E1", lineHeight: "1.5" }}>Resumo semanal gerado por IA enviado automaticamente para pais e diretores — com graficos e recomendacoes pedagogicas.</p>
              ...
              <div className="rounded-[1vw] p-[1.8vw]" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)" }}>
                ...
                <div className="flex flex-col gap-[1.2vh]">
                  ...
                  <div className="flex items-center gap-[0.8vw]">
                    ...
                    <p className="font-body" style={{ fontSize: "1.1vw", color: "#CBD5E1" }}>Banco de questoes privado</p>
                  </div>
                  <div className="flex items-center gap-[0.8vw]">
