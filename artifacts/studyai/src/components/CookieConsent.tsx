    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 p-4">
        ...
        <div className="flex gap-2 mt-3">
          ...
          <button
            onClick={accept}
            className="flex-1 flex items-center justify-center gap-1 py-2 rounded-xl bg-indigo-600 text-white text-xs font-semibold hover:bg-indigo-700 transition-colors"
          >
