      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center bg-white/70 backdrop-blur-sm rounded-2xl border-2 border-dashed border-violet-300 z-10">
        <div className="flex flex-col items-center gap-3 text-center px-4">
          ...
          <button
            ...
            disabled={loading}
            className="mt-1 flex items-center gap-1.5 bg-gradient-to-r from-violet-600 to-purple-600 text-white text-xs font-semibold px-4 py-2 rounded-full shadow-md hover:shadow-lg hover:scale-105 transition-all disabled:opacity-60"
          >
