...
/* ─── Imagem por estado ───────────────────────────── */
const STATE_IMAGE: Record<CharacterState, string> = {
  idle:      "/tiagao-character.png",
  listening: "/tiagao-character.png",
...
export function TiagaoCharacter({
  ...
  const currentImage = imageSrc || STATE_IMAGE[state] || "/tiagao-character.png";
