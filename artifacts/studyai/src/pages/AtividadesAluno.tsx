        ...
        <div className="px-5 pb-5 flex items-center justify-between gap-3">
          ...
          {!result && questions.length > 0 && (
            <button
              ...
              className="flex items-center gap-2 px-5 py-2 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white text-sm font-black transition-all disabled:opacity-40 disabled:cursor-not-allowed"
            >
