...
const MATERIA_COLORS: Record<string, string> = {
  ...
  "Física": "bg-purple-100 text-purple-700",
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1.5">
                      {note.processedContent && (
                        <span title="IA processada"><Brain className="w-3 h-3 text-purple-400" /></span>
                      )}
            ...
            >
              ...
              <div className="flex-1 flex flex-col bg-white rounded-2xl shadow-sm border border-amber-100 overflow-hidden min-w-0">
                ...
                <div className="px-4 py-3 border-b border-amber-50 flex items-center gap-2 flex-wrap">
                  ...
                  {!isCreating && selectedId && (
                    <button
                      ...
                      disabled={aiLoading}
                      className="flex items-center gap-1.5 px-3 py-1.5 bg-purple-600 hover:bg-purple-700 disabled:opacity-40 text-white rounded-lg text-xs font-bold transition-colors"
                    >
                ...
                <div className="px-5 py-2 border-t border-amber-50 flex items-center justify-between">
                  ...
                  {editContent.length > 100 && !isCreating && !processed && (
                    <button onClick={handleProcess} disabled={aiLoading} className="text-xs text-purple-600 hover:underline font-medium">
                      ✨ Processar com IA
                    </button>
                  )}
                </div>
              ...
              {processed && !isCreating && (
                <motion.div
                  initial={{ opacity: 0, x: 20 }}
                  animate={{ opacity: 1, x: 0 }}
                  className="w-80 flex-shrink-0 bg-white rounded-2xl shadow-sm border border-purple-100 overflow-hidden flex flex-col hidden lg:flex"
                >
                  <div className="px-4 py-3 bg-gradient-to-r from-purple-600 to-violet-600 text-white flex items-center gap-2">
                    ...
                    {([
                      ...
                      <button
                        ...
                        className={`flex-1 flex flex-col items-center gap-0.5 py-2 text-xs font-semibold transition-colors ${
                          aiTab === tab.id ? "text-purple-600 border-b-2 border-purple-500" : "text-gray-400 hover:text-gray-600"
                        }`}
                      >
                        ...
                        {processed.flashcards.map((card, i) => (
                          ...
                          >
                            <div className={`p-3 rounded-xl border-2 transition-all ${
                              flipCard === i ? "bg-purple-50 border-purple-200" : "bg-gray-50 border-gray-100"
                            }`}>
              ...
              {!processed && !isCreating && selectedId && (
                <div className="w-72 flex-shrink-0 bg-white rounded-2xl shadow-sm border border-dashed border-purple-200 items-center justify-center text-center p-8 hidden lg:flex flex-col">
