              ...
              <div className="w-full max-w-3xl">
                ...
                >
                  <textarea
                    ...
                    rows={2}
                    aria-label="Mensagem para o Tiagão"
                  ...
                  <div className="flex items-center justify-between gap-2 px-3 pb-3">
                    <div className="flex items-center gap-1">
                      {/* Anexos / opções extras vão no painel do Tiagão; aqui só
                          encaminhamos o usuário pra lá pra manter o caminho único. */}
                      <button
                        type="button"
                        onClick={() => openTiagao()}
                        title="Anexar material no Tiagão"
